...
import 'package:bahrain_admin/Cards/NewVariationCard/NewVariationCard.dart';
...
import 'package:bahrain_admin/Screen/AddNewVariation/AddNewVariations.dart';
...
class ShowNewVariationList extends StatefulWidget {
  @override
  _ShowNewVariationListState createState() => _ShowNewVariationListState();
}

class _ShowNewVariationListState extends State<ShowNewVariationList> {
...
bool  _isLoading = true;
 ...
 Future<void> _allData() async {
  ...
  void _bestProductsState() {
    var products = AllVariationModel.fromJson(body);
    if (!mounted) return;
    setState(() {
      productsData = products.allVariation;
      _isLoading = false;
    });
   ...
   Navigator.push( context, FadeRoute(page: ProductTypeView()));
        ...
        body:_isLoading?Center(
          ...
          child: GestureDetector(
             onTap: (){
             //  print("f");
 Navigator.push( context, FadeRoute(page: AddNewVariation()));
