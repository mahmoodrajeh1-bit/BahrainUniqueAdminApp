...
class _EditCouponState extends State<EditCoupon> {
  ...
  void initState() {
    ...
    couponController.text = widget.data.code==null?"":'${widget.data.code}';
    discountController.text = widget.data.discount==null?"":'${widget.data.discount}';
    _couponType =  widget.data.type==null?"":'${widget.data.type}';
    counterController.text = widget.data.counter==null?"":'${widget.data.counter}';
    date = widget.data.validity==null?"":'${widget.data.validity}';
    super.initState();
  }
  ...
  void _addNewCoupon() async {
    ...
    var res = await CallApi().postData(data, '/app/editCoupon');
