...
import 'package:bahrain_admin/Screen/NewProductsListCard/NewProductsListCard.dart';
...
bool  _isLoading = true;
 ...
 Future<void> _allData() async {
  ...
  Future<void> _showProducts() async {
    var key = 'new-products-list';
    await _getLocalBestProductsData(key);

    var res = await CallApi().getData('/app/newProduct');
...
//           onTap: (){
//  Navigator.push(context, SlideLeftRoute(page: AddProduct()));
...
//       ),
    ...
    for (var d in productsData) {
     ...
     //   print(d.status);
      ...
      Slidable(
        ...
        //  d.isNew==0?showItemAlert("add","as New",
        //    OutlineButton(
        ...
        //         showItemAlert("remove","from New Products",
        //    OutlineButton(
        //                              // color: Colors.greenAccent[400],
        //                               child: new Text(
        //                                 "Yes",
 ...
 setState(() {
   ...
   // print(body);
    ...
    //         SharedPreferences localStorage = await SharedPreferences.getInstance();
    // localStorage.setString('new-products-list', json.encode(productData));
  
         
          //_showProducts();
     
        // Navigator.push(
        //                   context, SlideLeftRoute(page: NewProductList()));
