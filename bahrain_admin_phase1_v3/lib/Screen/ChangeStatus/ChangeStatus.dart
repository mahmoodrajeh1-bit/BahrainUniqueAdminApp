...
//     if(categoryName=="Assigned to driver"){
// setState(() {
...
//     }
    ...
    if(widget.data.driver == null){
      _showDefaultDriver();
       ...
       assignId  = widget.data.driver.id;
      var first = widget.data.driver.firstName==null?"":widget.data.driver.firstName;
      var last = widget.data.driver.lastName==null?"":widget.data.driver.lastName;
  ...
  void _orderState() {
    ...
    setState(() {
      ...
      defaultDriverName  = first + " " +last;
      _isLoading = false;
    //    drivername = widget.data.driver == null
    //     ? defaultDriverName
    ...
    // assignId = widget.data.driver == null
    //     ? assignId.toString()
  ...
  void _changeStatus() async {
    ...
    var bodyDriver;
    var body;
    if (int.parse(categoryId) == 3) {
      var dataDriver = {
        'id': widget.data.id,
        'driverId': assignId,
        'customerId': customerId,
        'status': categoryName//'Assigned to driver'
      };
      ...
      bodyDriver = json.decode(resDriver.body);
     ...
     // print(body);
    ...
    else if (int.parse(categoryId) == 1) {
      var dataDriver = {
        'id': widget.data.id,
        'driverId': null,
        'customerId': customerId,
      ...
      "customerId": customerId,
      'status':
          categoryName, //int.parse(categoryId)==3?categoryName+" "+drivername:categoryName,
      'deliveryDate': date
    };
   ...
   //  Navigator.push( context, FadeRoute(page: PendingOrderList()));
      ...
      if (body['success'] == true) {
        ...
        //  Navigator.push( context, FadeRoute(page: PendingOrderList()));
        //  }
                    //  else if (int.parse(categoryId) == 7) {
        //  Navigator.push( context, FadeRoute(page: DeliveryOrderList()));
        //  }
        //  else if (int.parse(categoryId) == 8) {
