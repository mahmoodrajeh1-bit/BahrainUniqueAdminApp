...
class VariationValueListCard extends StatefulWidget {
  var data;
  VariationValueListCard(this.data);

  @override
  _VariationValueListCardState createState() => _VariationValueListCardState();
}

class _VariationValueListCardState extends State<VariationValueListCard> {
  bool open = true;
  var orderedItem;
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                widget.data.variation.name == null
                                    ? ""
                                    : "Variation: "+ widget.data.variation.name,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            "Are you sure want to delete this variation value?",
            // textAlign: TextAlign.,
            style: TextStyle(
 ...
 var data = {
    ...
    var res = await CallApi().postData(data, '/app/deleteproductVariationValue');
    ...
    if (body['success'] == true) {
      ...
      Navigator.push(
          context, new MaterialPageRoute(builder: (context) => ShowVariationValueList()));
    }
