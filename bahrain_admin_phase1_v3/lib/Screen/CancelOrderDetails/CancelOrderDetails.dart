...
class CancelOrderDetails extends StatefulWidget {
  var data;
  CancelOrderDetails(this.data);
  @override
  _CancelOrderDetailsState createState() => _CancelOrderDetailsState();
}
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      widget.data.used_vaoucher == null
                          ? Container()
                          : Row(
                              children: <Widget>[
                                Container(
                                ...
                                Container(
                                  child: Text(
                                    widget.data.used_vaoucher.voucher.code ==
                                            null
                                        ? "---"
                                        : widget.data.used_vaoucher.voucher.code
                                                .toString() +
                                            " (" +
                                            widget.data.used_vaoucher.voucher
                                                .discount
                                                .toString() +
                                            "%)",
                                    textAlign: TextAlign.left,
                          ...
                          widget.data.firstName == null &&
                              ...
                              : Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        launch(widget.data.mobile1 != null
                                            ?
