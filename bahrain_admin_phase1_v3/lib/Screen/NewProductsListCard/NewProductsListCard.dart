...
class NewProductsListCard extends StatefulWidget {
  var data;
  NewProductsListCard(this.data);

  @override
  _NewProductsListCardState createState() => _NewProductsListCardState();
}

class _NewProductsListCardState extends State<NewProductsListCard> {
  bool open = true;
  var orderedItem;
 ...
 _showMsg(msg) {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
       onTap: () {
         Navigator.push( context, FadeRoute(page: ProductsDetailsPage(widget.data)));
      },
      child: Card(
        elevation: 1,
       ...
       widget.data.isNew==0?showItemAlert("add","as New",
         OutlineButton(
