...
import 'package:bahrain_admin/Screen/EditCoupon/EditCoupon.dart';
...
class _CouponListCardState extends State<CouponListCard> {
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: Column(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                widget.data.code == null?Container(): Container(
                            ...
                            widget.data.type == null?Container():  Container(
                          ...
                          widget.data.discount == null?Container():  Container(
                              margin: EdgeInsets.only(top: 5),
                              child: Text(
                            ...
                            widget.data.validity == null?Container(): Container(
                              margin: EdgeInsets.only(top: 5),
                              child: Text(
                               
                                widget.data.validity == null
                                    ? ""
                                    : "Validity: "+ widget.data.validity,
                                overflow: TextOverflow.ellipsis,
                                textDirection: TextDirection.ltr,
                                style: TextStyle(
                                    color: Color(0xFF343434),
                            ...
                            widget.data.counter == null?Container():   Container(
                              margin: EdgeInsets.only(top: 5),
                              child: Text(
                               
                                widget.data.counter == null
                                    ? ""
                                    : "Counter: "+ widget.data.counter.toString(),
                                overflow: TextOverflow.ellipsis,
                                textDirection: TextDirection.ltr,
                                style: TextStyle(
                                    color: Color(0xFF343434),
            ...
            //             Navigator.push(
            // context, new MaterialPageRoute(builder: (context) => EditCoupon(widget.data)));
            //           },
            //           icon: Icon(
            //             Icons.edit,
            //             color: appColor,
 ...
 var data = {
    ...
    var res = await CallApi().postData(data, '/app/deleteCoupon');
   ...
   Navigator.of(context).pop();
      Navigator.push(
          context, new MaterialPageRoute(builder: (context) => ShowCouponList()));
    }
