...
import 'package:bahrain_admin/redux/reducer.dart';
import 'package:redux_thunk/redux_thunk.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'Screen/NotificationPage/NotificationPage.dart';
...
final store = Store<AppState>(reducer,
    initialState: AppState(
        demoState: "",
        categoryInitClick: false,
        categoryListsRedux: [],
        subcategoryInitClick: false,
        subcategoryListsRedux: [],
        unseenNotification: 0),
    middleware: [thunkMiddleware]);

int bottomNavIndex = 0;
Color appColor = Color(0xFF003680);
String url = 'https://admin.bahrainunique.com';
// String imgUrl = 'http://192.168.1.102:8000';
      ...
      child: MaterialApp(
        ...
        home: _isLoggedIn
            ? StoreConnector<AppState, AppState>(
                ...
                builder: (context, items) => HomePage(),
              )
            : LogInPage(),
        theme: new ThemeData(
